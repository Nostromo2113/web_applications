...
<div class="tasksWrap">
    ...
    >
        <div style="margin-bottom: 8px;">
            ...
            <button-item @click="OpenCloseAccordion()" v-if="!taskFullWindow" style="top: 5px;">▼</button-item>
            <button-item @click="$router.push(`/taskpage/${taskItems.id}`)" v-if="!taskFullWindow"   style="top: 40px; right: 6px;">📄</button-item>
...
.task-item {
    ...
    box-shadow: 0px 0px 3px 0px darkorange;
...
.task-item-after {
    box-shadow: 0px 0px 3px 0px rgb(79 145 219 / 66%);
}

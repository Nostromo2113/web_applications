  ...
  <div class="footer container">
    <div class="footer__payments">
      <div class="footer__guarantee">
        <div class="footer__guarantee__img">
          <svg
            width="70"
            height="70"
            viewBox="0 0 69 92"
          ...
          >
            <path
              d="M67.1614 11.9709L35.8513 0.485746C35.4735 0.346892 34.9668 0.277466 34.46 0.277466C33.9532 0.277466 33.4464 0.346892 33.0686 0.485746L1.75854 11.9709C0.993758 12.2486 0.367188 13.2008 0.367188 14.0736V61.9185C0.367188 62.7913 0.892401 63.9418 1.52819 64.4873L33.2898 91.1274C33.6123 91.3952 34.0269 91.534 34.4508 91.534C34.8746 91.534 35.2985 91.3952 35.6118 91.1274L67.3733 64.4873C68.0091 63.9517 68.5343 62.8012 68.5343 61.9185V14.0736C68.5528 13.2008 67.9262 12.2585 67.1614 11.9709ZM51.276 28.9111L31.6865 57.9414C31.5488 58.1443 31.3685 58.3093 31.1604 58.4231C30.9522 58.5369 30.7221 58.5962 30.4886 58.5962C30.2552 58.5962 30.025 58.5369 29.8169 58.4231C29.6087 58.3093 29.4285 58.1443 29.2908 57.9414L17.6439 40.6839C17.2938 40.1582 17.6439 39.4243 18.2429 39.4243H23.3291C23.7991 39.4243 24.2506 39.6722 24.527 40.0788L30.4886 48.906L44.393 28.2961C44.6694 27.8895 45.1117 27.6415 45.5908 27.6415H50.6771C51.276 27.6515 51.6262 28.3854 51.276 28.9111Z"
              fill="#ffffffc5"
            />
          </svg>
        </div>
        <div class="foote__guqrantee__discription">
      ...
      <ul class="footer__payments__list">
        <li class="footer__payments__item">
          <img width="140" height="40" src="/payments/3.svg" />
        </li>

        <li class="footer__payments__item">
          <img width="140" height="40" src="/payments/2.svg" />
        </li>
        <li class="footer__payments__item">
          <img width="140" height="40" src="/payments/1.svg" />
        </li>
        <li class="footer__payments__item">
          <img width="140" height="40" src="/payments/4.svg" />
        </li>
      </ul>
    </div>
    <div class="footer-lover">
      ...
      <div class="footer__nav p">
        <ul class="footer__nav__list">
          <li class="footer__nav__item p"><default-btn>О нас</default-btn></li>
          <li class="footer__nav__item">
            <default-btn>Конфиденциальность</default-btn>
          </li>
          <li class="footer__nav__item"><default-btn>Контакты</default-btn></li>
          <li class="footer__nav__item">
            <default-btn>Договор оферты</default-btn>
          </li>
        </ul>
        <ul class="footer__nav__list">
          <li class="footer__nav__item">
            <default-btn>Пользовательское соглашение</default-btn>
          </li>
          <li class="footer__nav__item"><default-btn>Гарантии</default-btn></li>
          <li class="footer__nav__item">
            <default-btn>Правовая информация</default-btn>
          </li>
          <li class="footer__nav__item">
            <default-btn>Поддержка</default-btn>
          </li>
        </ul>
      </div>
